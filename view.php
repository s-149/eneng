        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">OUTPUT DATA</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th>Values of KUR</th>
                  <th>Values of SKU</th>
                  <th>Values of Revenue</th>
                  <th>Values of Expenditure</th>
                  <th>Values of Civil Serpant</th>
                  <th></th>
                </tr>
                </thead>
                <tbody>
    ...
    if(mysql_num_rows($query) == 0){  //ini artinya jika data hasil query di atas kosong
      ...
      while($data = mysql_fetch_assoc($query)){ //perulangan while dg membuat variabel $data yang akan mengambil data di database
        ...
        echo '<tr>';
          ...
          echo '<td>'.$data['kewarganegaraan'].'</td>'; //menampilkan data nama lengkap dari database
          echo '<td>'.$data['bidangusaha'].'</td>'; //menampilkan data nis dari database
          echo '<td align="center">'.$data['kriteria1'].'</td>';  //menampilkan data kelas dari database
          echo '<td align="center">'.$data['kriteria2'].'</td>';  //menampilkan data jurusan dari database
          echo '<td align="center">'.$data['kriteria3'].'</td>';
          echo '<td align="center">'.$data['kriteria4'].'</td>';
          echo '<td align="center">'.$data['kriteria5'].'</td>';
          echo '<td>
          <a href="edit.php?nik='.$data['nik'].'">Edit</a> | 
          <a href="hapus.php?nik='.$data['nik'].'">Delete</a> 
          </td>';
