    ...
    <section class="content">        
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">NORMALIZATION DATA</h3>
            </div>
...
//Gunakan Koneksi
  ...
  $bobot = array(0.3,0.2,0.1,0.15,0.25);
...
//Hitung Normalisasi tiap Elemen
  ...
  // echo "<h1>Matrix Normalization</h1>
  ...
  while ($dt2 = mysql_fetch_array($sql2)) {
    echo "<tr>
      ...
      <td align='center'>".round($min['maxK1']/$dt2['kriteria1'],2)."</td>
      <td align='center'>".round($dt2['kriteria2']/$max['maxK2'],2)."</td>
      <td align='center'>".round($dt2['kriteria3']/$max['maxK3'],2)."</td>
      <td align='center'>".round($min['maxK4']/$dt2['kriteria4'],2)."</td>
      <td align='center'>".round($min['maxK5']/$dt2['kriteria5'],2)."</td>
    </tr>";
